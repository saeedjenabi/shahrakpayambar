...
$correct_password = "Sa@304508"; // رمز عبور مدیر
...
<head>
  <meta charset="UTF-8" />
  <title>لیست درخواست‌ها | فقط ادمین</title>
  <style>
...
<body>
  <div class="container">
    <h2>لیست درخواست‌های ثبت‌شده</h2>
    ...
    <table>
      ...
      <tbody>
        ...
        if (file_exists($file)) {
          ...
          echo "<tr><td colspan='7'>هیچ درخواستی ثبت نشده است.</td></tr>";
        }
        ?>
      </tbody>
    </table>
